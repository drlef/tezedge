...
#[test]
fn can_deserialize_operations_for_blocks_right_nom() -> Result<(), Error> {
    let message_bytes = hex::decode("000000660061b12238a7c3577d725939970800ade6b82d94a231e855b46af46c37850dd02452030ffe7601035ca2892f983c10203656479cfd2f8a4ea656f300cd9d68f74aa625870f7c09f7c4d76ace86e1a7e1c7dc0a0c7edcaa8b284949320081131976a87760c300")?;
    let (_input, messages) = peer_message_response(&message_bytes).unwrap();
    assert_eq!(1, messages.messages().len());
...
#[test]
fn can_deserialize_operations_for_blocks_left_nom() -> Result<(), Error> {
    let message_bytes = hex::decode("")?;
    let (_input, messages) = peer_message_response(&message_bytes).unwrap();
    assert_eq!(1, messages.messages().len());
...
#[test]
fn can_deserialize_operations_for_blocks_left_and_right() -> Result<(), Error> {
    ...
    match message {
        PeerMessage::OperationsForBlocks(message) => {
            // assert_eq!("", HashType::BlockHash.bytes_to_string(message.operations_for_block().hash()));
            assert_eq!(0, message.operations().len());
            match message.operation_hashes_path() {
                Path::Right(path) => {
                    // assert_eq!("LLoZQD2o1hNgoUhg6ha9dCVyRUY25GX1KN2TttXW2PZsyS8itbfpK", HashType::OperationListListHash.bytes_to_string(path.left()));
                    match path.path() {
                        Path::Left(path) => {
                            // assert_eq!("LLoZQD2o1hNgoUhg6ha9dCVyRUY25GX1KN2TttXW2PZsyS8itbfpK", HashType::OperationListListHash.bytes_to_string(path.right()));
                            match path.path() {
...
#[test]
fn error_deserialize_operations_for_blocks_bad_size() -> Result<(), Error> {
    let message_bytes = hex::decode("000000550102")?;
    let error_result = peer_message_response(&message_bytes);
    match error_result {
        Err(Err::Failure(e)) => {
            assert_eq!(e.input, vec![1, 2]);
